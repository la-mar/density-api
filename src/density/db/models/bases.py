...
class AggregateProxy:
    ...
    async def count(self) -> int:
        return await db.func.count(self.default_column).gino.scalar()

    async def max(self, column: Union[str, Column] = None) -> int:
        ...
        return await db.func.max(column).gino.scalar()

    async def min(self, column: Union[str, Column] = None) -> int:
        ...
        return await db.func.min(column).gino.scalar()
